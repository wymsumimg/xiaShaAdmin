<template>
  <div class="detail">
    ...
    <div class="detail-item" flex v-if="state != 1">
      <div class="detail-item-left">受理人员：</div>
      <div class="detail-item-right">
        <p></p>
      </div>
    </div>
    ...
    <div class="detail-item" flex v-if="state != 1">
      <div class="detail-item-left">受理时间：</div>
      <div class="detail-item-right">
        <p></p>
      </div>
    </div>
    ...
    <div class="detail-item" flex v-if="state == 1">
      <div class="detail-item-left">宽带账号：</div>
      <div class="detail-item-right">
        <p></p>
      </div>
    </div>
    ...
    <div class="detail-item" flex v-if="state == 1">
      <div class="detail-item-left">宽带密码：</div>
      <div class="detail-item-right">
        <p></p>
      </div>
    </div>
    ...
    <div class="detail-item" flex v-if="state == 1">
      <div class="detail-item-left">到期时间：</div>
      <div class="detail-item-right">
        <p></p>
      </div>
    </div>
    ...
    <div class="detail-item" flex v-if="state == 1">
      <div class="detail-item-left">井道位置：</div>
      <div class="detail-item-right">
        <p></p>
      </div>
    </div>
    ...
    <div class="detail-item" flex v-if="state == 1">
      <div class="detail-item-left">SN：</div>
      <div class="detail-item-right">
        <p></p>
      </div>
    </div>
    ...
    <div class="detail-item" flex v-if="state == 1">
      <div class="detail-item-left">PON：</div>
      <div class="detail-item-right">
        <p></p>
      </div>
    </div>
    ...
    <div class="detail-item" flex v-if="state == 3">
      <div class="detail-item-left">返回原因：</div>
      <div class="detail-item-right">
        <p></p>
      </div>
    </div>
