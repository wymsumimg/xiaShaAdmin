    ...
    <div class="container">
        ...
        <div flex="main:justify" flex-wrap>
            ...
            <div class="wrapper" style="width:100%">
                ...
                <el-table-column align="center" header-align="center" label="一级人员获得佣金" prop="date" >
                    <slot slot-scope="scope">
                    <div class="orFont">{{scope.row.productName}}</div>
                    </slot>
                </el-table-column>
...
export default {
  ...
  data() {
    return {
      ...
      productNum: 1,
      timeModel:2,
      totalObj:{objOne:{title:'销售总额'},objTwo:{title:'订单数'},objThree:{title:'获得佣金'},objFour:{title:'二级人员卖出'}},
    };
  },
  created() {
    this.getTop()
